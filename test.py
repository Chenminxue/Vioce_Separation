...
def main(args):
    ...
    for wav_filename, wav_mono, stft_mono in zip(song_filenames, wavs_mono, stfts_mono):
        ...
        #保存数据
        sf.write(wav_mono_filepath, wav_mono, dataset_sr)
        sf.write(wav_music_hat_filepath, y_music_hat, dataset_sr)
        sf.write(wav_voice_hat_filepath, y_voice_hat, dataset_sr)
